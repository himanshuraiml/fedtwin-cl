...
DATA_PATH = os.path.join(os.path.dirname(__file__), "processed", "cmapss_sites.npz")
    ...
    for method in methods:
        ...
        for r in range(N_ROUNDS):
            ...
            for i, dc in enumerate(DEVICE_CLASSES):
                ...
                if use_masking and triggered and site_free.any():
            ...
            for i, dc in enumerate(DEVICE_CLASSES):
                ...
                records.append({"benchmark": "fed-twin-cmapss-real", "method": method, "site_id": i,
        ...
        for f in ctfr_flags:
            records.append({"benchmark": "fed-twin-cmapss-real", "method": method, "site_id": f["site"],
...
if __name__ == "__main__":
    recs = run_cmapss()
    out_path = os.path.join(os.path.dirname(__file__), "cmapss_real_results.json")
